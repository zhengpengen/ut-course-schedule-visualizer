        ...
        <div className="schedule">
          ...
          {schedule.map((classEntry) => (
            <div className="classEntry">
              ...
              <div>{classEntry.id} {classEntry.professor}</div>
              {classEntry.time_and_locations.map((time_and_locations) => (
                <div>{time_and_locations.location} | {time_and_locations.weekday?.toString().replaceAll(',',' ')} | {time_and_locations.start_time} {time_and_locations.start_time}{time_and_locations.start_time=='' ? '' : '-'}{time_and_locations.end_time}</div>
              ))}
            </div>
          ))}
        </div>
